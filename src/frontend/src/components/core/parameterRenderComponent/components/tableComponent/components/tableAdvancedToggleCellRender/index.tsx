    ...
    parameter && (
      <ShadTooltip
        content={
          disabled
            ? isTweaks
              ? t("Cannot enable input of connected handles")
              : t("Cannot change visibility of connected handles")
            : isTweaks
              ? t("Toggle input of the field in the API")
              : t("Change visibility of the field")
        }
        styleClasses="z-50"
      >
