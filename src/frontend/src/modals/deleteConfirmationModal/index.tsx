    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <span className="pb-3 text-sm">
          {note 
            ? t("This will permanently delete the {{description}} {{note}}", { description: description ?? t("flow"), note })
            : t("This will permanently delete the {{description}}", { description: description ?? t("flow") })
          }<br />
          <br />
